@extends('layouts.app')
@section('main')
    <h5 style="color: black;"> <i class="bi bi-pencil-square"></i> Edit Product</h5>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea name="description" id="description"
                        ...
                        style="resize: none;height: 160px;" placeholder="Enter Description">{{ old('description', $product->description) }}</textarea>
                    @if ($errors->has('name'))
